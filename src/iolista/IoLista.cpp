...
void IoLista::autoAbrir(){

   // QString fileName="C:/Users/victor/Desktop/Radit-Estable/WindowDesktop/release/defaultlst/defaultlst.lst";
   QString fileName =QCoreApplication::applicationDirPath().toLatin1() + "/defaultlst/defaultlst.lst";

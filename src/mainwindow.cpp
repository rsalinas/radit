    ...
    ui(new Ui::MainWindow)
{
    ...
    IoLista * iolista = new IoLista(w_Player->w_Lista);
    iolista->autoAbrir();
    delete iolista;
    ListaEstado * listaestado = new ListaEstado(w_Player->w_Lista);
    listaestado->SetItem(0);
    listaestado->SetVerde();
